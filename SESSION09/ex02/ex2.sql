...
EXPLAIN ANALYZE 
SELECT * FROM Customers WHERE PhoneNumber = '0912345678';
-- Tạo Composite Index
CREATE INDEX idx_BranchID_Salary ON Employees(BranchID, Salary);
EXPLAIN
SELECT * FROM Employees WHERE BranchID = 1 AND Salary > 1500000;
...
---------------------------
ALTER TABLE Employees DROP　FOREIGN KEY (BranchID);
